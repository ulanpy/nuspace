...
async def upsert_template(
    ...
    """
    # Policy check
    TemplatePolicy(user=user, db_session=db_session).check_create(payload)
...
async def list_templates(
    ...
    """
    # Policy check
    TemplatePolicy(user=user, db_session=db_session).check_read_list(course_id)
...
async def get_template(
    ...
    TemplatePolicy(user=user, db_session=db_session).check_read_one(template)
