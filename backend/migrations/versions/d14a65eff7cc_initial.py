...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_grade_reports_course_code"), "grade_reports", ["course_code"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "media_format",
            sa.Enum("banner", "carousel", "profile", name="media_format"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "education_level", sa.Enum("UG", "GRM", "PHD", name="education_level"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Enum(
                ...
                "MECHANICAL_AND_AEROSPACE_ENGINEERING",
                ...
                "WORLD_LANGUAGES_LITERATURE_AND_CULTURE",
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum(
                "default", "admin", "boss", "capo", "soldier", "community_admin", name="userrole"
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum("club", "university", "organization", name="community_type"),
            nullable=False,
        ),
        sa.Column(
            "category",
        ...
        sa.Column(
            "recruitment_status",
            sa.Enum("open", "closed", "upcoming", name="community_recruitment_status"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_communities_established"), "communities", ["established"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_communities_recruitment_status"),
        "communities",
        ["recruitment_status"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_course_templates_course_id"), "course_templates", ["course_id"], unique=False
    )
    op.create_index(
        op.f("ix_course_templates_student_sub"), "course_templates", ["student_sub"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_degree_audit_results_student_sub"),
        "degree_audit_results",
        ["student_sub"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_planner_schedules_student_sub"), "planner_schedules", ["student_sub"], unique=False
    )
    op.create_table(
        "student_courses",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_student_courses_student_sub"), "student_courses", ["student_sub"], unique=False
    )
    op.create_table(
        "student_schedules",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_student_schedules_student_sub"), "student_schedules", ["student_sub"], unique=False
    )
    op.create_index(
        op.f("ix_student_schedules_term_label"), "student_schedules", ["term_label"], unique=False
    )
    op.create_index(
        op.f("ix_student_schedules_term_value"), "student_schedules", ["term_value"], unique=False
    )
    op.create_table(
        "tickets",
        sa.Column("id", sa.BigInteger(), nullable=False),
        ...
        sa.Column(
            "status",
            sa.Enum("open", "in_progress", "closed", "resolved", name="ticket_status"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_community_achievements_year"), "community_achievements", ["year"], unique=False
    )
    op.create_table(
        "community_members",
        sa.Column("id", sa.BigInteger(), nullable=False),
    ...
    op.create_index(
        op.f("ix_conversations_sg_member_sub"), "conversations", ["sg_member_sub"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_course_items_student_course_id"),
        "course_items",
        ["student_course_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("pending", "approved", "rejected", "cancelled", name="event_status"),
            nullable=False,
        ),
        sa.Column(
            "tag",
            sa.Enum("featured", "promotional", "regular", "charity", name="event_tag"),
            nullable=False,
        ),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column("updated_at", sa.DateTime(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(), nullable=False),
        sa.ForeignKeyConstraint(
            ["planner_schedule_id"], ["planner_schedules.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_planner_schedule_courses_course_code"),
        "planner_schedule_courses",
        ["course_code"],
        unique=False,
    )
    op.create_index(
        op.f("ix_planner_schedule_courses_level"),
        "planner_schedule_courses",
        ["level"],
        unique=False,
    )
    op.create_index(
        op.f("ix_planner_schedule_courses_planner_schedule_id"),
        "planner_schedule_courses",
        ["planner_schedule_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_planner_schedule_courses_registrar_course_id"),
        "planner_schedule_courses",
        ["registrar_course_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_planner_schedule_courses_school"),
        "planner_schedule_courses",
        ["school"],
        unique=False,
    )
    op.create_index(
        op.f("ix_planner_schedule_courses_term_label"),
        "planner_schedule_courses",
        ["term_label"],
        unique=False,
    )
    op.create_index(
        op.f("ix_planner_schedule_courses_term_value"),
        "planner_schedule_courses",
        ["term_value"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "permission",
            sa.Enum("VIEW", "ASSIGN", "DELEGATE", name="permission_type"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "collaborator_type",
            sa.Enum("user", "community", name="collaborator_type"),
            nullable=False,
        ),
        sa.Column("user_sub", sa.String(), nullable=True),
        sa.Column("community_id", sa.BigInteger(), nullable=True),
    ...
    op.create_index(
        op.f("ix_event_collaborators_event_id"), "event_collaborators", ["event_id"], unique=False
    )
    op.create_index(
        op.f("ix_event_collaborators_user_sub"), "event_collaborators", ["user_sub"], unique=False
    )
    op.create_table(
        "messages",
        sa.Column("id", sa.BigInteger(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(), nullable=False),
        sa.ForeignKeyConstraint(
            ["planner_schedule_course_id"], ["planner_schedule_courses.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_planner_schedule_sections_planner_schedule_course_id"),
        "planner_schedule_sections",
    ...
    op.create_index(
        op.f("ix_message_read_status_read_at"), "message_read_status", ["read_at"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_planner_schedule_courses_term_value"), table_name="planner_schedule_courses"
    )
    op.drop_index(
        op.f("ix_planner_schedule_courses_term_label"), table_name="planner_schedule_courses"
    )
    ...
    op.drop_index(
        op.f("ix_planner_schedule_courses_course_code"), table_name="planner_schedule_courses"
    )
    ...
    op.drop_index(
        op.f("ix_community_achievements_community_id"), table_name="community_achievements"
    )
