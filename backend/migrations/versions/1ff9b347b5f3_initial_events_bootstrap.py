...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("scope", sa.Enum(name="userscope"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("policy", sa.Enum(name="event_policy"), nullable=False),
        sa.Column("name", sa.String(), nullable=False),
        sa.Column("place", sa.String(), nullable=False),
        sa.Column("event_datetime", sa.DateTime(), nullable=False),
        sa.Column("description", sa.String(), nullable=False),
        sa.Column("duration", sa.Integer(), nullable=True),
        sa.Column("scope", sa.Enum(name="event_scope"), nullable=False),
        sa.Column("type", sa.Enum(name="event_type"), nullable=False),
        sa.Column("status", sa.Enum(name="event_status"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("collaborator_type", sa.Enum(name="collaborator_type"), nullable=False),
        sa.Column("user_sub", sa.String(), nullable=True),
        sa.Column("community_id", sa.BigInteger(), nullable=True),
        sa.Column("created_at", sa.DateTime(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("condition", sa.Enum(name="product_condition"), nullable=False),
        sa.Column("status", sa.Enum(name="product_status"), nullable=False),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column("updated_at", sa.DateTime(), nullable=False),
    ...
    op.create_table(
        "reviews",
        sa.Column("id", sa.BigInteger(), primary_key=True, autoincrement=True, nullable=False),
        sa.Column("reviewable_type", sa.Enum(name="reviewable_type"), nullable=False),
        sa.Column("entity_id", sa.BigInteger(), nullable=False),
        sa.Column("user_sub", sa.String(), nullable=False),
        sa.Column("rating", sa.Integer(), nullable=False),
        sa.Column("content", sa.Text(), nullable=True),
        sa.Column("owner_type", sa.Enum(name="owner_type"), nullable=False),
