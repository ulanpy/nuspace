...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("type", sa.Enum(name="opportunity_type", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("education_level", sa.Enum(name="education_level", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), primary_key=True, autoincrement=True),
        sa.Column("opportunity_id", sa.Integer(), sa.ForeignKey("opportunities.id", ondelete="CASCADE"), nullable=False),
        sa.Column("major", sa.Enum(name="opportunity_major", create_type=False), nullable=False),
    )
