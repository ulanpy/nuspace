...
import type { AuditSearch } from "@/routes/_app/courses/audit"
import {
...
import { AuditResult } from "@/components/routes/courses/components/audit-result"
import { TransferCreditDialog } from "@/components/routes/courses/components/transfer-credit-dialog"
import {
  mergeTransferCreditMappings,
  transferCreditMappingRows,
} from "@/lib/courses/audit"
import { registrarErrorMessage } from "@/lib/courses"
import type { AuditResponse, TransferCreditMapping } from "@/lib/courses"
import type { TransferCreditMappingRow } from "@/lib/courses/audit"
...
export function Page({
  ...
  search: AuditSearch
  onSearchChange: (updater: (previous: AuditSearch) => AuditSearch) => void
}) {
  const { year, majors = [], minors = [] } = search
