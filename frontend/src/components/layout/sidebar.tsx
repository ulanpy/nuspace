...
function NuspaceLogo({ collapsed = false, onNavigate }: NuspaceLogoProps) {
  ...
  if (collapsed) {
    return (
      <Link
        ...
        onClick={onNavigate}
        className={cn(
          "flex shrink-0 items-center justify-center rounded-lg p-1.5 text-foreground transition-colors hover:bg-muted/80",
          linkFocus,
        )}
        title="Announcements"
      >
  ...
  return (
    <Link
      ...
      onClick={onNavigate}
      className={cn(
        "flex items-center gap-2 overflow-hidden rounded-lg px-1 py-0.5 -mx-1 text-foreground transition-colors hover:bg-muted/80",
        linkFocus,
      )}
      title="Announcements"
    >
      <img
        ...
        aria-hidden
      />
      <span className="text-xl font-bold whitespace-nowrap transition-all duration-300 ease-in-out">
        Nuspace
      </span>
    </Link>
  );
  ...
  return (
    <>
            ...
            <div className="flex flex-col h-full p-6">
              <SheetHeader className="mb-6">
                <SheetTitle className="flex items-center justify-between gap-3">
                  <NuspaceLogo onNavigate={handleNavigate} />
      ...
      >
        ...
        <div
          className={cn(
            "flex items-center h-[72px] px-3 border-b transition-all overflow-hidden shrink-0",
