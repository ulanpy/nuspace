...
import { useUpdateEvent } from "@/features/campuscurrent/hooks/events/useUpdateEvent";
import { useDeleteEvent } from "@/features/campuscurrent/hooks/events/useDeleteEvent";
...
import { CreateEventData, EditEventData, EventType, Event, Permissions, Community } from "@/features/campuscurrent/types/types";
    ...
    try {
      if (isEditMode && event) {
        ...
        const createData: CreateEventData = {
          community_id: isCommunityEvent ? selectedCommunity?.id : undefined,
