...
import { PreSearchedProduct, Product} from "@/features/marketplace/types";
import { QueryParams, NewProductRequest, UpdateProductRequest } from "@/features/marketplace/types";
...
export const marketplaceApi = {
  ...
  getUserProductsQueryOptions: () => {
    return queryOptions({
      queryKey: [marketplaceApi.baseKey, "userProducts"],
      queryFn: async () => {
