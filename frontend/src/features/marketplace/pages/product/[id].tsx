...
import { useProduct } from "@/features/marketplace/api/hooks/useProduct";
import { Spinner } from "@/components/atoms/spinner";
import { ROUTES } from "@/data/routes";

import { ProductImageCarousel } from "@/features/marketplace/components/product-detail-page/ProductImageCarousel";
import { ProductDetails } from "@/features/marketplace/components/product-detail-page/ProductDetails";
import { ReportListingModal } from "@/features/marketplace/components/product-detail-page/ReportListingModal";
import { ImageViewerModal } from "@/features/marketplace/components/product-detail-page/ImageViewerModal";
import { UnifiedEditListingModal } from "@/features/marketplace/components/main-page/my-listings/UnifiedEditListingModal";
    ...
    const handleDeleteProduct = async () => {
        if (product) {
            try {
                ...
                navigate(ROUTES.APPS.MARKETPLACE.ROOT);
            } catch (error) {
                toast({
                    title: "Error",
        ...
        return (
            <div className="container mx-auto px-4 py-6">
                ...
                <div className="text-center py-12">
                    ...
                    <Button onClick={() => navigate(ROUTES.APPS.MARKETPLACE.ROOT)}>
